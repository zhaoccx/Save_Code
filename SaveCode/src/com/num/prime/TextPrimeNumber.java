...
public class TextPrimeNumber {
	...
	/**
	 * 筛选法求质数，返回数组中，<code>true</code>为质数，<code>false</code>为非质数
	 * 
	 * @param num
	 *            输入的数字
	 * @return 质数数组
	...
	public static void tostring(boolean[] lb) {
	...
	public static void testArrarys() {
		String[][][] newInstance = (String[][][]) Array.newInstance(String.class, 2, 4, 5);
		System.out.println(newInstance[1][2].length);
