	...
	try {
		...
		if (urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png'
			...
			if (imageGroup) {
				...
				for (TB_Counter = 0; ((TB_Counter < TB_TempArray.length) && (TB_NextHTML === "")); TB_Counter++) {
					...
					if (!(TB_TempArray[TB_Counter].href == url)) {
						...
						TB_FoundURL = true;
						TB_imageCount = "第" + (TB_Counter + 1) + "张/共"
			...
			imgPreloader.onload = function() {
				...
				$("#TB_window")
						.append(
								"<a href='' id='TB_ImageNext'><img id='TB_Image' src='"
										+ url
										+ "' width='"
										+ imageWidth
										+ "' height='"
...
function fixMarginTop(offsetHeight, documentElement, scrollTop) {
	return (0
			- parseInt(offsetHeight / 2)
			+ (TBWindowMargin = documentElement && documentElement.scrollTop
					|| scrollTop) + 'px')
}
jQuery.fn.o = function(showobj, timeout, speed) {
