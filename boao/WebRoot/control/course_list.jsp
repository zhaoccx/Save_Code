...
<body>
	<form id="pageForm" action="/admin/courseList" method="post">
		<table class="tbl" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="tbl_left"></td>
				<td align="left" valign="middle" class="tbl_middle">科目/年级--》科目管理</td>
				...
				<td class="context">
					<div class="tbl_div">
						<table border="1" align="center" cellpadding="0" cellspacing="0">
							<tr>
								<td height="30" colspan="6" align="left" valign="middle"><a href="/admin/toAddCourse">点击这里进入添加科目</a></td>
							</tr>
							<tr>
								<td height="30" colspan="6" align="left" valign="middle">筛选:<select name="category" onchange="location.href='/admin/courseList?category='+this.options[this.selectedIndex].value;">
										<option value="">全部</option>
										<c:forEach items="${COURSE_CATEGORIES }" var="item">
							...
							<tr>
								...
								<td width="150" height="30" align="center" valign="middle" bgcolor="#EAEAEA">类型</td>
								<td width="250" height="30" align="center" valign="middle" bgcolor="#EAEAEA">说明</td>
								<td width="150" height="30" align="center" valign="middle" bgcolor="#EAEAEA">操作</td>
							</tr>

							<!--Content Start-->
							<c:forEach var="item" items="${objs}">
								<tr onmouseout="onMouseOut(this)" onmouseover="onMouse(this)">
									...
									<td width="120" height="30" align="center" valign="middle">${item.introduce}</td>
									<td width="150" height="30" align="center" valign="middle"><a href="/admin/toEditCourse-${item.id}?kind=${kind }" class="STYLE11">编辑</a>&nbsp;|&nbsp; <a href="javascript:del(${item.id},'${item.subject}');" class="STYLE10">删除</a></td>
								</tr>
							</c:forEach>
							<!--Content End-->

							<tr>
								<td height="60" colspan="6" align="left" valign="middle"><br /> <input type="hidden" name="sum" id="sum" value="${page.sum}" /> <input type="hidden" name="count" id="count" value="${page.count}" /> <input type="hidden" name="limit" id="limit" value="${page.limit}" />
									<p>
