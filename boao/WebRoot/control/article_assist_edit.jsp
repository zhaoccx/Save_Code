...
<body>
	<form name="form1" method="post" enctype="multipart/form-data" action="../admin/doEditAssist">
		<input type="hidden" name="id" value="${ENTITY.id }" /> <input type="hidden" name="kind" value="${kind }" />
		<table class="tbl" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="tbl_left"></td>
				<td class="tbl_middle">帮助/公告-->${kind }管理-->编辑${kind }</td>
			...
			<tr>
				...
				<td class="context">
					...
					<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
							<td height="220" align="left"><br />
								<fieldset>
									...
									<table width="700" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="563" height="33" align="left"><input name="subject" type="text" id="subject" size="55" maxlength="155" value="${ENTITY.subject }" /> <span class="STYLE2">*</span>（主题必须填写）</td>
										</tr>
										<tr>
											...
											<td height="33" align="left"><select name="category">
													<c:forEach var="item" items="${CATEGORY_LIST}">
														<option value="${item.id}" <c:if test="${ENTITY.category eq item.id}" >selected</c:if>>${item.subject}</option>
													</c:forEach>
								...
								<fieldset>
									...
									<table width="700" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td height="33" align="center" valign="middle"><textarea name="body" cols="80" rows="20" id="context">${ENTITY.body }</textarea> <ck:replace replace="context" basePath="ckeditor/"></ck:replace></td>
										</tr>
									</table>
								</fieldset> <br />
								<fieldset>
									...
									<table width="700" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="140" height="33" align="left" valign="middle" colspan="2"><c:if test="${!empty ENTITY.logo}">
													<img src="${PICSERVER }${ENTITY.logo }" />
												</c:if></td>
										</tr>
										<tr>
						...
						<tr>
							<td height="50" align="center" valign="middle"><input type="submit" name="but_submit" id="but_submit" onclick="sign_submit()" value="提交保存" /> <a href="../admin/assistList?kind=${kind }" class="cancel">取消返回</a></td>
						</tr>
					</table> <!--Content End-->
				</td>
				<td class="right">
