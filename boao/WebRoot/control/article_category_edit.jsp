...
<body>
	<form name="form1" method="post" action="../admin/doEditArticleCategory">
		<input type="hidden" name="id" value="${ENTITY.id }" />
		<table class="tbl" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="tbl_left"></td>
				<td class="tbl_middle">帮助/公告--》类型管理--》编辑类型</td>
									...
									<table width="700" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td height="33" align="left"><select name="kind">
													<option value="帮助中心" <c:if test="${ENTITY.kind eq '帮助中心' }">selected</c:if>>帮助中心</option>
													<option value="网站公告" <c:if test="${ENTITY.kind eq '网站公告' }">selected</c:if>>网站公告</option>
													<option value="普通文章" <c:if test="${ENTITY.kind eq '普通文章' }">selected</c:if>>普通文章</option>
											</select> <span class="STYLE2">*</span>（请选择当类型所需种类）</td>
										</tr>
										<tr>
											<td width="140" height="33" align="right" valign="middle">备注：</td>
											<td width="563" height="33" align="left"><input name="remark" type="text" id="remark" size="55" maxlength="155" value="${ENEITY.remark }" /></td>
										</tr>
										<tr>
											<td width="140" height="33" align="right" valign="middle">创建时间：</td>
											<td width="563" height="33" align="left"><fmt:formatDate type="both" value="${ENTITY.createDate }" pattern="yyyy/MM/dd HH:mm:ss" /></td>
										</tr>
									</table>
								</fieldset></td>
						</tr>
