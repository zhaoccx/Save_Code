...
<body>
	<form name="form1" method="post" action="/admin/editCourse">
		<input name="id" value="${obj.id }" />
		<table class="tbl" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="tbl_left"></td>
				<td class="tbl_middle">科目/年级--》科目管理--》编辑科目</td>
							...
							<td height="220" align="left"><br />
								<fieldset>
									...
									<table width="700" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="140" height="33" align="right" valign="middle">名称：</td>
											<td width="563" height="33" align="left"><input name="subject" type="text" id="subject" size="55" maxlength="155" value="${obj.subject }" /> <span class="STYLE2">*</span>（名称必须填写）</td>
										</tr>
										<tr>
											<td width="140" height="33" align="right" valign="middle">说明：</td>
											<td width="563" height="33" align="left"><input name="introduce" type="text" size="100" maxlength="155" value="${obj.introduce }" /></td>
										</tr>
										<tr>
											<td width="140" height="33" align="right" valign="middle">所属类型：</td>
											<td height="33" align="left"><select name="category">
													<c:forEach var="item" items="${COURSE_CATEGORIES}">
														<option value="${item}" <c:if test="${item eq course.category }">selected</c:if>>${item}</option>
													</c:forEach>
											</select> <span class="STYLE2">*</span>（请选择当前所属类型）</td>
										</tr>
									</table>
								</fieldset></td>
						</tr>
