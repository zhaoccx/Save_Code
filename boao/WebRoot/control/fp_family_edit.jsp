...
<body>
	<form name="form1" id="form1" method="post" enctype="multipart/form-data" action="action!toUpdateFamily.do">
		<table class="tbl" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="tbl_left"></td>
				<td class="tbl_middle">名人库--》名人精英--》修改名人家族</td>
			...
			<tr>
				...
				<td bgcolor="#FF0000" class="context">
					<!--Content Start-->
					<ul class="context_ul">
						<li><a style="margin-left:120px;" href="../${FAMOURS_PERSON_ENTITY.middlePic}" class="fleft" target="_blank"> <img src="../${FAMOURS_PERSON_ENTITY.middlePic}" width="370" height="250" border="2" />
						</a></li>
						<li>
							<fieldset class="fdt">
								<legend>
								...
								<label>家族主题 ：</label><input name="subject" type="text" value="${FAMOURS_PERSON_ENTITY.subject}" size="50" maxlength="255" /> <span class="red">*</span> ( 内容只为示范,请按实际填写 )<br /> <label>家族名称 ：</label><input name="cnname" type="text" id="cnname" value="${FAMOURS_PERSON_ENTITY.cnname}" size="50" maxlength="255" /> <span class="red">*</span> ( 内容只为示范,请按实际填写 )<br /> <label>从事领域 ：</label> <select name="industry">
									<option value="${FAMOURS_PERSON_ENTITY.industry}" selected="selected">${FAMOURS_PERSON_ENTITY.industry}</option>
									<option value="著名家族">著名家族</option>
									<option value="出色博奥">出色博奥</option>
									<option value="巾帼博奥">巾帼博奥</option>
									<option value="慈善事业">慈善事业</option>
								</select> <span class="red"> *</span> ( 请填家族从事领域或行业 )<br /> <label>企业/公司：</label><input name="enname" type="text" id="enname" value="${FAMOURS_PERSON_ENTITY.enname}" size="30" maxlength="80" /> <span class="red"> *</span> ( 家族企业/单位的名称 )
							</fieldset>
							<br />
						</li>
						...
						<li class="bottom"><input type="button" name="but_submit" id="but_submit" onclick="sign_submit()" value="提交保存" /> &nbsp;&nbsp;&nbsp; <a style="margin-left:50px;" href="action!toFamily.do">取消并返回</a></li>
