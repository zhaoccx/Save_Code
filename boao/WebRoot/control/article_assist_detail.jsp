...
<body>
	<table class="tbl" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td class="tbl_middle">帮助/公告-->${kind }管理-->${kind }详情</td>
		...
		<tr>
			...
			<td class="context">
				...
				<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
							...
							<fieldset>
								...
								<table width="700" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="563" height="33" align="left">${ENTITY.subject }</td>
									</tr>
									<tr>
										<td width="140" height="33" align="right" valign="middle">所属类型：</td>
										<td height="33" align="left">${ENTITY.category }</td>
									</tr>
									<tr>
										<td width="140" height="33" align="right" valign="middle">创建时间：</td>
										<td height="33" align="left"><fmt:formatDate value="${ ENTITY.createDate}" pattern="yyyy-MM-dd hh:mm:ss" /></td>
									</tr>
								</table>
							</fieldset> <br />
							<fieldset>
								...
								<table width="700" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="140" height="33" align="left" valign="middle" colspan="2"><c:if test="${!empty ENTITY.logo }">
											...
											</c:if> <c:if test="${empty ENTITY.logo }">无</c:if></td>
					...
					<tr>
						<td height="50" align="center" valign="middle"><a href="../admin/assistList?kind=${kind }" class="cancel">取消返回</a></td>
					</tr>
				</table> <!--Content End-->
			</td>
			<td class="right">
