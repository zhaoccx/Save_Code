...
<body>
	<form name="form1" method="post" action="/admin/addCourse">
		<table class="tbl" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="tbl_left"></td>
				<td class="tbl_middle">科目/年级--》科目管理--》添加科目</td>
								...
								<fieldset>
									...
									<table width="700" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="563" height="33" align="left"><input name="subject" type="text" id="subject" size="55" maxlength="155" /> <span class="STYLE2">*</span>（名称必须填写）</td>
										</tr>
										<tr>
											<td width="140" height="33" align="right" valign="middle">说明：</td>
											<td width="563" height="33" align="left"><input name="introduce" type="text" id="subject" size="100" maxlength="155" /></td>
										</tr>
										<tr>
