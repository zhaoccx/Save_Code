...
<body>
	<form name="form1" id="form1" method="post" enctype="multipart/form-data" action="action!toSavePerson.do">
		<table class="tbl" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="tbl_left"></td>
				<td class="tbl_middle">名人库--》名人精英--》添加名人精英</td>
					...
					<ul class="context_ul">
						...
						<li>
							<fieldset class="fdt">
								...
								<label>名人主题：</label><input name="subject" type="text" value="阮次山：西方正观察金正恩思考如何打交道" size="50" maxlength="255" /> <span class="red">*</span> ( 内容只为示范,请按实际填写 )<br /> <label>中文名称：</label><input name="cnname" type="text" id="cnname" value="中文名称" size="30" maxlength="80" /> <span class="red">*</span> ( 请填写人物中文名称 )<br /> <label>英文名称：</label><input name="enname" type="text" id="enname" value="Username" size="30" maxlength="80" /> <span class="red"> *</span> ( 请填写人物英文名称 )<br /> <label>杰出领域：</label><select name="industry">
									<option value="博奥领袖" selected="selected">博奥领袖</option>
						...
						<li>
							<fieldset class="fdt">
								...
								<label>大图片：</label> <input name="large" type="file" size="32" /> <span class="red">*</span> ( 用于在首页展示[百强名人]<strong> 宽:680PX - 高:460PX</strong> )<br /> <label>中图片：</label> <input name="middle" type="file" id="middle" size="32" /> <span class="red">*</span> ( 用于在名人库与首页[跑马灯] <strong>宽:100PX - 高:120PX</strong>)<br /> <label>小图片：</label> <input name="small" type="file" id="small" size="32" /> <span class="red"> * </span>( 人物小图像[预览图] <strong>宽:65PX - 高:75PX</strong>)<br />
							</fieldset>
							<br />
						</li>
						...
						<li>
							<fieldset class="fdt">
								...
								<textarea name="context" cols="80" rows="20">这里填写详细信息</textarea>
						...
						<li><input type="hidden" name="category" value="0" /> <input type="hidden" name="isUser" value="0" /> <input type="hidden" name="userId" value="0" /> <input type="hidden" name="allowReply" value="0" /> <input type="hidden" name="clicks" value="0" /> <input type="hidden" name="supports" value="0" /> <input type="hidden" name="comments" value="0" /></li>
					</ul> <!--Content End-->
				</td>
				<td class="right">
					<!--Table Right Side-->
