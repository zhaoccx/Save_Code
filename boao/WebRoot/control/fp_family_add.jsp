...
<body>
	<form name="form1" id="form1" method="post" enctype="multipart/form-data" action="action!toSaveFamily.do">
		<table class="tbl" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="tbl_left"></td>
				<td class="tbl_middle">名人库--》名人精英--》添加名人家族</td>
				...
				<td bgcolor="#FF0000" class="context">
					...
					<ul class="context_ul">
						...
						<li>
							<fieldset class="fdt">
								<legend>
									家族基本信息 (<span class="STYLE1"> 带 '</span><span class="red">*</span>'<span class="STYLE1">号的为必填字段</span> )
								</legend>
								<label>家族主题 ：</label><input name="subject" type="text" value="这里是家族的主题（简短描述）" size="50" maxlength="255" /> <span class="red">*</span> ( 内容只为示范,请按实际填写 )<br /> <label>家族名称 ：</label><input name="cnname" type="text" id="cnname" value="这里是家族名称" size="50" maxlength="255" /> <span class="red">*</span> ( 内容只为示范,请按实际填写 )<br /> <label>从事领域 ：</label> <select name="industry">
									<option value="著名家族" selected="selected">著名家族</option>
									<option value="出色博奥">出色博奥</option>
									<option value="巾帼博奥">巾帼博奥</option>
									<option value="慈善事业">慈善事业</option>
								</select> <span class="red"> *</span> ( 请填家族从事领域或行业 )<br /> <label>企业/公司：</label><input name="enname" type="text" id="enname" value="集团/公司/单位/机构名称" size="30" maxlength="80" /> <span class="red"> *</span> ( 家族企业/单位的名称 )
							</fieldset>
							<br />
						</li>
						...
						<li>
							<fieldset class="fdt">
								...
								<label>家族封面图片：</label> <input name="middle" type="file" size="32" /> <span class="red">*</span> ( 用于名人家族主页中做展示 <strong> 宽:370PX - 高:250PX</strong> )
							</fieldset>
							<br />
						</li>
						...
						<li>
							<fieldset class="fdt">
								...
								<label>所在地区：</label> <input name="region" type="text" id="region" value="亚洲、欧洲、南美洲" size="20" maxlength="60" /> ( 请填写所在区域 )<br /> <label>籍贯信息：</label> <select id="country" name="country">
						...
						<li>
							<fieldset class="fdt">
								<legend>
									详细内容 ( <span class="STYLE1">家族详细内容</span> )
								</legend>
								<textarea name="context" cols="80" rows="20">这里是家族的详细内容，可在此处直接上传图片并编辑</textarea>
						...
						<li>
							<fieldset class="fdt">
								...
								<label>关键词：</label><input name="tags" type="text" size="30" value="tags1,tags2,tags3" maxlength="80" /> <span class="red"> *</span>( 关键能够有利于用户以及系统搜索 )
							</fieldset>
							<br />
						</li>
						...
						<li>
							<fieldset class="fdt">
								...
								<label>中文</label><input type="radio" name="encoding" value="cn" checked="checked" /> <label>英文</label> <input type="radio" name="encoding" value="en" /> <span class="red">*</span> ( 决定当前数据是属于<strong>中文/英文</strong>下的条目 )
							</fieldset>
							<br />
						</li>
						...
						<li><input type="hidden" name="category" value="1" /> <input type="hidden" name="isUser" value="0" /> <input type="hidden" name="userId" value="0" /> <input type="hidden" name="allowReply" value="0" /> <input type="hidden" name="clicks" value="0" /> <input type="hidden" name="supports" value="0" /> <input type="hidden" name="comments" value="0" /></li>
					</ul> <!--Content End-->
				</td>
				<td class="right">
					<!--Table Right Side-->
