...
<body>
	<form name="form1" method="post" enctype="multipart/form-data" action="action!toSaveCategory.do">
		<table class="tbl" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="tbl_left"></td>
				<td class="tbl_middle"><c:if test="${CATEGORY_TYPE_NAME=='news'}">新闻/资讯管理中心-->添加新类型</c:if> <c:if test="${CATEGORY_TYPE_NAME=='history'}">历史/文化管理-->添加新类型</c:if> <c:if test="${CATEGORY_TYPE_NAME=='magic'}">玄学算术管理中心-->添加新类型</c:if></td>
								...
								<fieldset>
									...
									<table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr>
											...
											<td width="450" height="30" align="left"><input name="subject" type="text" id="subject" value="栏目名称" size="25" maxlength="255" /> <span class="STYLE2">*</span>(请输入栏目/类型名称)</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td height="100" align="left" valign="top"><textarea name="context" cols="36" rows="6" id="context">这里是栏目基本描述</textarea></td>
										</tr>
									</table>
								</fieldset>
							</td>
