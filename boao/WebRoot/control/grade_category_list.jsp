...
<body>
	<table class="tbl" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td align="left" valign="middle" class="tbl_middle">科目/年级--》年级类型管理</td>
					...
					<table border="1" align="center" cellpadding="0" cellspacing="0">
						<tr>
							<td height="30" colspan="6" align="left" valign="middle">
								<form action="/admin/addGradeCategory">
						...
						<!--Content Start-->
						<c:forEach var="item" items="${GRADE_CATEGORIES}" varStatus="i" begin="${(page.num-1)*page.limit }" end="${page.num*page.limit }">
						...
						<tr>
							<td height="60" colspan="6" align="left" valign="middle"><br />
								<form id="pageForm" action="/admin/gradeCategoryList" method="post">
