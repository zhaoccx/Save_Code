...
<body>
	<form name="form1" method="post" enctype="multipart/form-data" action="action!toUpdatePartner.do">
		<table class="tbl" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="tbl_left"></td>
				<td class="tbl_middle">博奥好学网 --》 修改合作伙伴</td>
						...
						<tr>
							<td height="130" align="center">
								<fieldset>
									...
									<p>
										<img src="../${PARTNER_ENTITY.logoPath}" width="100" height="30" />
									</p>
									<input type="hidden" name="id" value="${PARTNER_ENTITY.id}" />
							...
							<td   align="left"><fieldset>
									...
									<table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr>
											...
											<td width="450" height="30" align="left"><input name="subject" type="text" id="subject" size="35" value="${PARTNER_ENTITY.subject}" maxlength="255" />(公司/网站CN名称)</td>
										</tr>
										<tr>
											<td width="120" height="30" align="right" valign="middle">英文主题：</td>
											<td width="450" height="30" align="left"><input name="subject2" type="text" id="subject2" size="35" value="${PARTNER_ENTITY.subject2}" maxlength="255" />(公司/网站EN名称)</td>
										</tr>
										<tr>
											<td width="120" height="30" align="right" valign="middle">条目类型：</td>
											<td width="450" height="30" align="left"><c:if test="${PARTNER_ENTITY.category==0}">
													<select name="category">
														<option value="0" selected="selected">博奥服务</option>
														<option value="1">友情连接</option>
													</select>
												</c:if> <c:if test="${PARTNER_ENTITY.category==1}">
													<select name="category">
														<option value="0">博奥服务</option>
														<option value="1" selected="selected">友情连接</option>
													</select>
												</c:if> (请选择类型，我方公司类型为：“博奥服务”)</td>
										</tr>
										<tr>
											<td width="120" height="30" align="right" valign="middle">连接地址：</td>
											<td width="450" height="30" align="left"><input name="link" type="text" id="link" size="35" value="${PARTNER_ENTITY.link}" maxlength="255" /></td>
										</tr>
										<tr>
										...
										<tr>
											<td height="30" colspan="2" align="center" valign="top"><textarea name="context" cols="33" rows="6" id="context">${PARTNER_ENTITY.context}</textarea></td>
										</tr>
										<tr>
											<td height="50" colspan="2" align="center" valign="middle"><input type="button" name="but_submit" id="but_submit" onclick="sign_submit()" value="提交保存" /> &nbsp;&nbsp;&nbsp;<a href="action!toPartner.do">取消,返回列表</a></td>
										</tr>
									</table>
								</fieldset></td>
						</tr>
