		...
		<tr>
			...
			<td valign="top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
					<tr>
						<td><span class="STYLE1">所有用户留言/反馈</span></td>
					</tr>
				</table>
			</td>
		...
		<tr>
			...
			<td valign="top" bgcolor="#F7F8F9"><table width="856" border="0" align="left" cellpadding="0" cellspacing="0">
					<tr>
						<td style="min-height:120px;">
							...
							<table width="773" border="1" align="center" style="border-bottom:#CCCCCC solid 1px; border-left:#CCCCCC solid 1px; border-right:#CCCCCC solid 1px; border-top:#CCCCCC solid 1px;" cellpadding="0" cellspacing="0">
								...
								<c:forEach var="msg" items="${MESSAGE_LIST}">
					...
					已读
								...
								<tr>
									<td height="25" colspan="7" align="left">&nbsp;共有信息记录<strong>${MESSAGE_TOTAL_NUM}</strong>条，其中有<strong>${MESSAGE_NR_NUM}</strong>条未读信息，当前是第<strong>${MESSAGE_PAGENO}</strong>页，该页下有<strong>${fn:length(MESSAGE_LIST)}</strong>条记录.&nbsp;&nbsp;<a href="action!toMsg.do?code=next">下一页</a> | <a href="action!toMsg.do?code=back">上一页</a></td>
								</tr>
							</table>
						</td>
					</tr>
