...
<body>
	<table class="tbl" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td align="left" valign="middle" class="tbl_middle"><c:if test="${USER_CATEGORY=='fail'}">未审核(新注册)用户列表</c:if> <c:if test="${USER_CATEGORY=='pass'}">已通过审核（正式）用户列表</c:if></td>
			...
			<td class="context">
				<div class="tbl_div">
					<table border="1" align="center" cellpadding="0" cellspacing="0">
						<tr>
							<td height="30" colspan="6" align="left" valign="middle">&nbsp;当前共有 ：${fn:length(USER_TOTAL_LIST)} 条记录.</td>
						</tr>
						<tr>
							<td width="50" height="30" align="center" valign="middle" bgcolor="#EAEAEA">编号Id</td>
							<td width="250" height="30" align="center" valign="middle" bgcolor="#EAEAEA">用户帐号</td>
							<td width="120" height="30" align="center" valign="middle" bgcolor="#EAEAEA">用户密码</td>
							<td width="150" height="30" align="center" valign="middle" bgcolor="#EAEAEA">注册日期</td>
						...
						<!--Content Start-->
						<c:forEach var="item" items="${USER_TOTAL_LIST}">
							<tr onmouseout="onMouseOut(this)" onmouseover="onMouse(this)">
								<td width="50" height="30" align="center" valign="middle">${item.id}</td>
								<td width="250" height="30" align="center" valign="middle">${item.username}</td>
								<td width="120" height="30" align="center" valign="middle">${item.password}</td>
								<td width="150" height="30" align="center" valign="middle">${item.regDate}</td>
								<td width="130" height="30" align="center" valign="middle"><c:if test="${item.passed==1}">已审核</c:if> <c:if test="${item.passed==0}">
										<font style="color:red;">未审核</font>
									</c:if></td>
								<td width="100" height="30" align="center" valign="middle"><a href="action!viewUser.do?id=${item.id}" class="STYLE11">查看详细</a></td>
							</tr>
						</c:forEach>
						<!--Content End-->
